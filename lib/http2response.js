...
Http2Response.prototype.getSetting = function(setting) {
    return [
        Http2.SettingIdentifier[this.readUInt24BE(setting.slice(Http2.SettingReservedSize, Http2.SettingReservedSize + Http2.SettingIdentifierSize))],
        setting.slice(Http2.SettingReservedSize + Http2.SettingIdentifierSize, setting.length).readUInt32BE(0)
    ];
};
/**
 * Frame Handlers
...
Http2Response.prototype.SETTINGS = function() {
    ...
    for (var i = 0, n = this.getNumberOfSettings(); i < n; i++) {
        this.setStreamConf(this.getSetting(this.payloadBuff.slice(i * Http2.SettingSize, (i + 1) * Http2.SettingSize)));
    }
